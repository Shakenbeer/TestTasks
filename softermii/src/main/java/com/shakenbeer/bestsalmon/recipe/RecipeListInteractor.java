...
public class RecipeListInteractor extends Interactor {

    private final RecipeRepository recipeRepository;

    @Inject
    public RecipeListInteractor(@Named(RxModule.IO) Scheduler workScheduler,
    ...
    public Observable<List<Recipe>> buildInteractorObservable(String... params) {
        return recipeRepository.nextRecipes();
    }
}
